...
《第七个测试剧本》是 [LingChat](https://github.com/SlimeBoyOwO/LingChat) 的**原创 meta 恐怖剧本 DLC**：多周目叙事、DDLC 风格的崩坏演出（突脸 / 立绘崩坏 / 鼠标磁吸强制选择 / 假死机 / 写诗小游戏崩坏 / 日志污染……），共 11 章、5 个结局。
...
1. 在 [Releases](../../releases) 下载 `第七个测试剧本-v1.0.0.zip`（无需解压）
